...
<body>
    ...
    <div class="main border-bottom" id="main">
            ...
            <div class="SIA_Ev-group  d-block col-12 col-xs-12 col-sm-12 col-md-12 col-lg-12 d-lg-flex justify-content-between">
                <div class="conten-boton pl-5  col-12 col-xs-12 col-sm-12 col-md-5 col-lg-5">
                    <a href="#formulariosFiltrar" id="btn-SIA_A-buscarAlumno" class=" btnBuscarCliente btn col-xs-12 col-sm-12 col-md-12 col-lg-12" rel="modal:open">
                        <span class="fas fa-sort-amount-down-alt"></span> Filtrar datos
                    </a>
                </div>
                <div class="conten-boton pl-5 col-12 col-xs-12 col-sm-12 col-md-5 col-lg-5">
                    <a href="#formulariosBuscarCliente" id="btn-SIA_A-busHistory" class="btnBuscarCliente btn col-xs-12 col-sm-12 col-md-12 col-lg-12" rel="modal:open">
                        <span class="fas fa-search text-center"></span> Buscar Alumnos
                    </a>
                </div>
            </div>
        ...
        <div class="groupGeneral-sia p-0  col-12 col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <div class="contenedorDatosAlumno mt-3 mb-3  d-block col-12 col-xs-12 col-sm-12 col-md-12 col-lg-12  justify-content-center">
        ...
        <form action="#" id="FormularioNotas" class="responsive" method="post">
            <div id="contenedorAlumnosXCursos" class="mainContent table-responsive mt-4 col-xs-12 col-sm-12 col-md-12 col-lg-12">
                ...
                <table id="tbHistoryAlumnos" class="table table-striped  table-bordered">
                    <thead>
                        <tr>
                            <th  class="col-1">n°</th>
                            <!-- <th class="d-none">CodAlumno</th> -->
                            <th class="col-3 pl-2 pr-5">Curso</th>
                            <th class="col-1">Modalidad</th>
                            <th class="col-2">Promedio</th>
                            <th class="col-1">Fecha.de.inicialización</th>
                            <th class="col-1">Fecha.de.Finalización</th>
                            <th class="col-1">Importe</th>


                        </tr>
                    </thead>
                    <tbody id="tbHistoryAlumnosBody">
    ...
    <script src="<?php echo $urlProyecto ?>JS/scripSIAAlumnosHistory.js?gsd" type="module"></script>
