            ...
            <form action="#" class="contenedor_formulario" id="contenedor_formulario" method="post">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 contenGeneralInfo">
                    <div class="form-group contenInfoEvento">
                        ...
                        <span class="DescripcionEvento">Simétrika trae para ti la clase magistral de Modelamiento BIM totalmente GRATUITO🏗</span>

                        <span class="DescripcionEvento">✅Viernes 30 de abril 8:00 p.m. (hora de Perú, México, Colombia) con el Ing. Renzo Rios Rugel y la clase magistral de  "Evolución del BIM en la Industria de la Construcción"   </span>
                       
                        <span class="DescripcionEvento">
¿Te los piensas perder?😳😱</span>
                    </div>
                </div>
                <input type="hidden" name="txtIdCurso" id="txtIdCurso" value="33">
                <input type="hidden" name="txtIdCampania" id="txtIdCampania" value="4">
                <input type="hidden" name="txtIdLista" id="txtIdLista" value="97">
    ...
    <script src="<?php echo $urlProyecto ?>JS/validacionFormulario.js?ghdh" type="module"></script>
</body>
